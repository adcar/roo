...
interface ProductScanInlineProps {
  onSelect: (productId: string) => void;
}

export function ProductScanInline({ onSelect }: ProductScanInlineProps) {
  ...
  const handleScan = async (barcodeToScan?: string) => {
    ...
    try {
      ...
      setBarcode('');
      setError(null);
      // Restart scanning after selecting
  ...
  return (
    <div className="space-y-4">
      {/* Camera Scanner */}
      <div className="relative w-full aspect-square bg-black rounded-lg overflow-hidden max-w-md mx-auto">
        <div
